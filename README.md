...
```javascript
import randn from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-randn@v0.0.9-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/random-base-randn/actions/workflows/test.yml/badge.svg?branch=v0.0.9
[test-url]: https://github.com/stdlib-js/random-base-randn/actions/workflows/test.yml?query=branch:v0.0.9
